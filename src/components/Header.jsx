...
const Header=()=>{
    return(
        <div>
<nav  className="flex justify-between h-23 px-20 ">
    <div >
<img  className="h-25" src="data:image/png;base64," alt="logo" />
            ...
            <ul className="flex mt-[30px] cursor-pointer">
                <li className="mx-5">Menu</li>
                <li className="mx-5">Location</li>
                <li className="mx-5">About</li>
                <li className="mx-5">Contact</li>
            </ul>
         <Button name={"Login"} className="bg-red-600 h-6 py-1 px-2 mt-10 text-white" />
            </nav>
        </div>
    )
}
